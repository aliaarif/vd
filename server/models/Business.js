...
const businessSchema = new mongoose.Schema({
        business_bid: { type: String, required: false, trim: false },
        ...
        business_categoryslug: { type: String, required: false, trim: true },
        ...
        business_state: { type: String, required: true, trim: true },
        business_city: { type: String, required: true, trim: true },
        business_locality: { type: String, required: false, trim: true },
        business_localityslug: { type: String, required: false, trim: true },
